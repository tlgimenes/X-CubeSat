...
{
    public:
        FunctionIf(FunctionVariableBool *boolean, Terminal *term, std::unordered_map<std::string, Function*> *variables);
        FunctionIf(std::vector<XCubeSatToken*> *tokens, Terminal *term, std::unordered_map<std::string, Function*> *variables) throw(std::bad_typeid*);
