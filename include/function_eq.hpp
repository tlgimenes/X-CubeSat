...
{
    public:
        FunctionEq(FunctionVariableInt *, FunctionVariableInt *, Terminal *term, std::unordered_map<std::string, Function*> *variables);
        FunctionEq(std::vector<XCubeSatToken*> *tokens, Terminal *term, std::unordered_map<std::string, Function*> *variables) throw(std::bad_typeid*);
