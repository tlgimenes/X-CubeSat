...
/* Constructor
 */
FunctionLeq::FunctionLeq(FunctionVariableInt *int1, FunctionVariableInt *int2, Terminal *term, std::unordered_map<std::string, Function*> *variables):Function(term, variables)
{
