...
/* Constructor
 */
FunctionFile::FunctionFile(FunctionVariableString *stringName, Terminal *term, std::unordered_map<std::string, Function*> *variables):Function(term, variables)
{
 ...
 */
FunctionFile::FunctionFile(std::vector<XCubeSatToken*> *tokens, Terminal *term, std::unordered_map<std::string, Function*> *variables) throw(std::bad_typeid*):Function(term, variables)
{
